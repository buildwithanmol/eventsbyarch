...
const SocialIcons = ({ margin }) => {
  return (
    <div className={`flex items-center justify-center ${margin} relative`}>
      <div class="group">
        <AiOutlineInstagram size={30} class='mx-1 cursor-pointer text-[#2C94AD] ' />
        <div class="hidden group-hover:block p-2 bg-white shadow-xl border absolute rounded-lg left-2  space-y-1 text-[#46a1b7]">
