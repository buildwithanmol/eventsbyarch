...
const About = () => {
  ...
  return (
    <>
      ...
      <section className='flex items-center justify-center sm:flex-row flex-col relative'>
        <Image src='/founder.jpg' alt='image'  width={350} height={350}  className=' sm:w-[450px] w-[350px] ' />
      ...
      <section className='flex items-center justify-center sm:flex-row flex-col relative'>
        <Image src={currentImage} alt='image' width={350} height={300}   className='sm:w-[450px]  w-[350px]' />
        <div className='px-12 py-2  '>
